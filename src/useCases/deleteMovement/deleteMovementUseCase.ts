...
export class DeleteMovementUseCase
  implements UseCase<DeleteMovementUseCaseData, boolean>
{
  constructor(
  ...
  async execute(
    data: DeleteMovementUseCaseData
    ...
    const lastMovement: Movement = (
      await this.movementRepository.genericFind({ page: 0, resultQuantity: 1 })
    )[0]
