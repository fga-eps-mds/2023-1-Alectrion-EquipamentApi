import { DeleteMovementUseCase, DeleteMovementUseCaseData, InvalidMovementError, NullFieldsError, TimeLimitError } from '../../useCases/deleteMovement/deleteMovementUseCase'

import { Controller } from '../protocols/controller'
import { badRequest, HttpResponse, ok, serverError, notFound, unauthorized } from '../helpers'
...
export class DeleteMovementController extends Controller {
    ...
    async perform(httpRequest: DeleteMovementUseCaseData): Promise<HttpResponse<Model>> {
