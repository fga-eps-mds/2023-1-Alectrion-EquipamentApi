...
<<<<<<< HEAD
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."equipment_situacao_enum" AS ENUM('Ativo', 'Empréstimo', 'Baixado', 'Manutenção', 'Reserva Técnica')`
    )
    await queryRunner.query(
...
>>>>>>> 88504d8 (#101 feat: tentando habilitar o campo senderPhone)
